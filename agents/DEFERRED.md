...
## [open] 086-hide-completed-rows — missing integration test for checkbox → hide → show flow
...
## [open] 086-hide-completed-rows — missing explicit template default assertion
- Source: agents/artifacts/086-hide-completed-rows-review.md
- Severity: low
...
## [open] 086-hide-completed-rows — missing UI rendering test for filtered rows
- Source: agents/artifacts/086-hide-completed-rows-review.md
- Severity: low
