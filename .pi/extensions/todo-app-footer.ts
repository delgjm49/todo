/**
 * Todo App Custom Footer
 *
 * Project-local Pi extension that replaces the default footer with a
 * colorful, labeled, easy-to-scan statusline. Only activates inside
 * the Todo_app repository.
 *
 * Features:
...
const TODO_APP_MARKER = "Todo_app";
...
export default function (pi: ExtensionAPI) {
	...
	pi.on("session_start", async (_event, ctx) => {
		// Scope strictly to this repository
		if (!process.cwd().includes(TODO_APP_MARKER)) return;
